    ...
    >
      <div className="mx-auto w-full max-w-6xl">
        ...
        <motion.h1
          ...
          className="theme-text max-w-5xl text-6xl font-black tracking-tight sm:text-7xl md:text-8xl"
        >
          SPARSH
          <br />
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="theme-text theme-border flex items-center gap-3 rounded-full border px-6 py-3 font-semibold transition-all duration-300 hover:border-[var(--theme-primary)]"
          >
            GitHub
          </a>
        </motion.div>
